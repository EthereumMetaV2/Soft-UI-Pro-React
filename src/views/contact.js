...
const Contact = (props) => {
  return (
    <div className="contact-container">
      <Helmet>
        <title>Contact - Soft UI Pro</title>
        <meta property="og:title" content="Contact - Soft UI Pro" />
      </Helmet>
      <Link to="/" className="contact-navlink">
        <HeaderFull className="contact-component"></HeaderFull>
      </Link>
      <div className="contact-contact">
        <div className="contact-container01">
          <div className="contact-form">
            <h2 className="contact-text headingOne">Contact us!</h2>
            <span className="contact-text1 lead">
              We&apos;d like to talk with you.
            </span>
            <form className="contact-form1">
              <label className="contact-text2 label">Name</label>
              <input
                type="text"
                placeholder="Full Name"
                className="contact-textinput small input"
              />
              <label className="contact-text3 label">Your message</label>
              <textarea
                rows="8"
          ...
          <div className="contact-info">
            <div className="contact-container04">
              ...
              <div className="contact-container05">
                <div className="contact-container06"></div>
