      ...
      <nav className="header-nav">
        <div className="header-container">
          <Link to="/" className="header-navlink">
            <span className="large">Ethereum Meta V2</span>
            <br></br>
          </Link>
          <div className="header-menu">
            ...
            <Link to="/whitepaper" className="header-navlink3">
              <span className="large header-text2">Whitepaper</span>
              <br></br>
            </Link>
          </div>
      ...
      <div data-type="MobileMenu" className="header-mobile-menu">
        ...
        <div className="header-mid">
          <div className="header-menu1">
            ...
            <Link to="/whitepaper" className="header-navlink7 large">
              Coming Soon
            </Link>
          </div>
        </div>
